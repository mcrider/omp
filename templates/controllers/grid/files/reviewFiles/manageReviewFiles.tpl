...
<div id="existingFilesContainer">
	<form id="manageReviewFilesForm" action="{url component="grid.files.review.ReviewFilesGridHandler" op="updateReviewFiles" monographId=$monographId|escape reviewType=$reviewType|escape round=$round|escape}" method="post">
