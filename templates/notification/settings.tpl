...
<ul>
	...
	<ul class="plain">
		<li><span>
			<input id="notificationMonographSubmitted" type="checkbox" name="notificationMonographSubmitted"{if !$smarty.const.NOTIFICATION_TYPE_MONOGRAPH_SUBMITTED|in_array:$blockedNotifications} checked="checked"{/if} />
...
<ul>
	...
	<ul class="plain">
		<li><span>
			<input id="notificationMetadataModified" type="checkbox" name="notificationMetadataModified"{if !$smarty.const.NOTIFICATION_TYPE_METADATA_MODIFIED|in_array:$blockedNotifications} checked="checked"{/if} />
...
<ul>
	...
	<ul class="plain">
		<li><span>
			<input id="notificationReviewerComment" type="checkbox" name="notificationReviewerComment"{if !$smarty.const.NOTIFICATION_TYPE_REVIEWER_COMMENT|in_array:$blockedNotifications} checked="checked"{/if} />
