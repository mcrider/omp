...
import('controllers.grid.files.final.FinalDraftFilesGridRow');
...
class FinalDraftFilesGridHandler extends GridHandler {
	...
	function initialize(&$request) {
			...
			if ($canUpload) {
				$this->addAction(
					new LegacyLinkAction(
						...
						$router->url($request, null, 'grid.files.submission.CopyeditingSubmissionFilesGridHandler', 'addFile', null, array('monographId' => $monographId, 'fileStage' => MONOGRAPH_FILE_FINAL)),
		...
		import('controllers.grid.files.final.FinalDraftFilesGridCellProvider');
