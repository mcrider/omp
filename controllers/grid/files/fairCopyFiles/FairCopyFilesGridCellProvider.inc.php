...
/**
 * @file controllers/grid/files/fairCopyFiles/FairCopyFilesGridCellProvider.inc.php
 *
 * Copyright (c) 2003-2010 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class FairCopyFilesGridCellProvider
 * @ingroup controllers_grid_files_fairCopyFiles
 *
 * @brief Subclass class for a FairCopyFiles grid column's cell provider
 */

import('lib.pkp.classes.controllers.grid.GridCellProvider');

class FairCopyFilesGridCellProvider extends GridCellProvider {
	/**
	 * Constructor
	 */
	function FairCopyFilesGridCellProvider() {
