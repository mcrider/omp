...
/**
 * @file controllers/grid/files/submission/CopyeditingSubmissionFilesGridHandler.inc.php
 *
...
class CopyeditingSubmissionFilesGridHandler extends SubmissionFilesGridHandler {
	...
	function returnFileRow(&$args, &$request) {
		...
		if($monographFile) {
			...
			$fileTypeToHandlerPath = array(MONOGRAPH_FILE_FINAL => 'controllers.grid.files.final.FinalDraftFilesGridHandler',
									MONOGRAPH_FILE_COPYEDIT => 'controllers.grid.files.copyedit.CopyeditingFilesGridHandler',
									MONOGRAPH_FILE_FAIR_COPY => 'controllers.grid.files.fairCopy.FairCopyFilesGridHandler');
