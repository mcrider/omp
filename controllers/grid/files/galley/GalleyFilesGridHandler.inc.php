...
import('controllers.grid.files.galley.GalleyFilesGridCategoryRow');
import('controllers.grid.files.galley.GalleyFilesGridRow');
import('controllers.grid.files.galley.GalleyFilesGridCellProvider');
	...
	function initialize(&$request) {
		...
		$this->addAction(
			new LegacyLinkAction(
				...
				$router->url($request, null, 'grid.files.submission.GalleySubmissionFilesGridHandler', 'addFile', null, array('monographId' => $monograph->getId(), 'fileStage' => MONOGRAPH_FILE_COPYEDIT)),
				'submission.addFile',
				null,
				'add'
			)
