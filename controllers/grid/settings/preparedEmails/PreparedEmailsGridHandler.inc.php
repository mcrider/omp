...
class PreparedEmailsGridHandler extends GridHandler {
	...
	function initialize(&$request) {
		...
		$emailTemplates =& $emailTemplateDao->getEmailTemplates(Locale::getLocale(), $context->getId());
		$rowData = array();
		...
		import('controllers.api.preparedEmails.linkAction.ResetAllEmailsLinkAction');
		$resetAllEmailsLinkAction =& new ResetAllEmailsLinkAction($request, $context->getId());
		$this->addAction($resetAllEmailsLinkAction);
